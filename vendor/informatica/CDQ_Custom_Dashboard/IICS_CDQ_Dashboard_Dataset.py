# -*- coding: utf-8 -*-
"""
Informatica Cloud Data Quality Dashboard Dataset Extractor
Part of the Data Governance Portfolio by Joshua Adekeye

This script extracts profiling metrics from Informatica IICS CDQ Profile Warehouse
for use in data governance dashboards and reporting.
"""
...
username = ""
password = ""
csv_file_path = r"./output"  # Updated to use relative path
